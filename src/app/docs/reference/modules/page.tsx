...
export const metadata = {
  title: { absolute: "Modules and imports · XS Reference" },
  description: "import for stdlib, use for files or directories, and inline module blocks for declaring sub-namespaces.",
};
