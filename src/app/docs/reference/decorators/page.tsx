...
export const metadata = {
  title: { absolute: "Decorators · XS Reference" },
  description: "Two categories: trigger decorators that schedule a function, and wrapping decorators that intercept every call.",
};
