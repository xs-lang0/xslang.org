...
export const metadata = {
  title: { absolute: "Numeric behavior · XS Reference" },
  description: "Integer division, modulo semantics, division by zero, float-to-int conversion, and overflow promotion.",
};
