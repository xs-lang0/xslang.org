...
const features = [
  ...
  ["Fast startup", "~4 ms to spin up a script. Beats Node and Python for small CLI tools. The bytecode VM (default) is ~4-9x the tree-walk interpreter on compute-heavy code; --jit adds another 3-5x on tight numeric loops on x86_64."],
